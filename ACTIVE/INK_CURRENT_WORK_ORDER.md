...
Do not execute the rose-window benchmark in INK-CLOUD-007.

Complete remaining feasible engine/regression checks, create the selection/implementation report with benchmark debt explicitly deferred, update DEV progress, then:
