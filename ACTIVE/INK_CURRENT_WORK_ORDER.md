...
EXPRESSIVE_STROKE = IMPLEMENTED
PATH_GEOMETRY_SEPARATION = PRESERVED
PATH_EDIT_AFTER_STYLE = PRESERVED
HISTORY = REUSED
SERIALIZATION_CONTRACT = PRESERVED
EXTRACTION_PROVENANCE = PRESERVED
ORDINARY_VECTOR_FALLBACK = PRESERVED
FORMAT_VERSION = 4
PACKAGE_MUTATION = 0
...
Per continuous-advance authorization, MR_PASS proceeds directly to clean promotion. No user pause is required.
