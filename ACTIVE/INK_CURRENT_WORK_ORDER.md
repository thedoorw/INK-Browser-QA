...
```text
TASK = INK-TECH-CLOSURE-001
FAILED_RUN = 36225526214
TARGET_EXACT_SHA = d6ce01dc47614100bedea2592e64c18f66bc28d3

FAILURE_STAGE = MATERIALIZE_PINNED_EXACT_REVISION
FAILURE_CLASS = INFRA_TRANSIENT
GITHUB_API = 502 Server Error
PRODUCT_TESTS_STARTED = NO
FOCUSED_TESTS_STARTED = NO
BROWSER_BATCH_STARTED = NO

DEV_REOPEN = NO
SOURCE_REVIEW = REMAINS PASS
PROMOTION = HOLD
ACTION = RETRY SAME EXACT SHA
```
