...
REVISION = MR_REVISE / G8_UI_RUNTIME_ISOLATION_ONLY
BASE_RUNTIME_RUN = 36109323685
BASE_TESTED_HEAD = 272c656cb98994540d3311f3f38dac1e95dfb519
BASE_UI = 105 / 110 PASS

G0-G7 = ACCEPTED
G8_SOURCE_DELTA = READY
FOCUSED_QA = PASS
WINDOWS_RUNTIME = NOT_RUN_BY_DEV / MR_OWNED

COMPACT_NEW_OPEN_SAVE = HIDDEN
COMPACT_EXPORT = RESPONSIVE_ALTERNATIVE / VISIBLE
BUILD_ID = 20260925-ui-rebuild-001-g8-runtime-r1 / APP+WORKER MATCH

ESCAPE_QA = REAL_DOM_KEYBOARD_PATH
TYPOGRAPHY_QA = CURRENT_--ui-font_AUTHORITY
COMPACT_TOOLBAR_QA = EFFECTIVE_SINGLE + CONTAINMENT
