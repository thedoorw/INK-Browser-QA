...
STATUS: `INK-TECH-DEBT-001_RUNTIME_RERUN_QUEUED / QA_HARNESS_PASS / UI-006_PHASE_C_TO_I_HOLD`
...
| MR_REVIEW | `QA HARNESS PASS / EXACT-SHA RUNTIME RERUN` |
...
| RUNTIME_QA | `QUEUED / TARGET 3e22c2f501e100674952650f333024d5b817d86f` |
| UI-006 | `Phase A+B preserved / Phase C–I HOLD` |
| NEXT_STAGE | `Runtime evidence → MR final disposition` |
