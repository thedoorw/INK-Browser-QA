...
STATUS: `INK-TECH-DEBT-001_QA_HARNESS_REVISE_INCOMPLETE / RUNTIME_HELD / UI-006_PHASE_C_TO_I_HOLD`
...
| MR_REVIEW | `51d9ca0 REVIEWED / HARNESS REVISE INCOMPLETE` |
...
| RUNTIME_QA | `HELD / prior run 35885929148 remains FAIL 69/71` |
| UI-006 | `Phase A+B preserved / Phase C–I HOLD` |
| NEXT_STAGE | `finish two authorized stale-assertion fixes → HANDOFF → Runtime rerun` |
