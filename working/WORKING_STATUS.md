...
| RUNTIME_QA | `Connector-003 run 35961649436 / exact SHA a873c432... / UI+Creative+Geometry PASS; Connector-004 runtime not executed` |
...
## Connector-004 Runtime timeout classification

```text
RUNTIME_RUN = 35970456976
TESTED_SHA = a050e0d87d9b53b2d0ad5c34baffb4a88a070fdc
RUNNER = DESKTOP-NSOQH69 / WORKING
UI = PASS
...
MR_REVISION =
  run-ink-runtime-batch.mjs timeout 240s → 360s
  PRODUCT_SOURCE_CHANGE = 0
  rerun exact revised SHA
```
