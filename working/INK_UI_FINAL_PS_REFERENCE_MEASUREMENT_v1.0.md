# INK Final UI — Photoshop Reference Measurement v1.0

STATUS: `FINAL_UI_REFERENCE / FROZEN_FOR_IMPLEMENTATION / NO_PRODUCT_CHANGE`

CAPABILITY_BASELINE: `ACTIVE/INK_CURRENT_CAPABILITY_BASELINE.md` — `FROZEN / POST-CONNECTOR-005 / UI-AUTHORITATIVE`
...
`PS_REFERENCE_MEASUREMENT_v1.0 = FINAL_UI_REFERENCE_LOCKED`
