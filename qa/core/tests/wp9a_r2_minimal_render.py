...
with sync_playwright() as p:
 ...
 png=base64.b64decode(exp['data'].split(',',1)[1]); (ROOT/'FLR012_Candidate_A_R2.png').write_bytes(png)
 Image.open(ROOT/'FLR012_Candidate_A_R2.png').convert('RGB').resize((212,300),Image.Resampling.LANCZOS).save(ROOT/'FLR012_Candidate_A_R2_Small_View.png')
 ink=page.evaluate('()=>INK_APP.flora.serializeDocument()'); (ROOT/'FLR012_Candidate_A_R2.ink').write_text(ink,encoding='utf-8')
